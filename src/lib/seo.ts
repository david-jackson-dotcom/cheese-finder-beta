...
export function updateSEOMetaTags() {
  ...
  // Update title
  document.title = `Cheese Finder - Hundreds of cheeses. Four paths of discovery. Filter by taste preferences, regional origin, dietary restrictions, or search by name.`;
